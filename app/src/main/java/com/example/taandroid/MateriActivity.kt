...
class MateriActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ApiConfig.getService().getMateri1().enqueue(object : Callback<ResponseMateri1> {
            override fun onResponse(
                call: Call<ResponseMateri1>,
                response: Response<ResponseMateri1>
            ) {
            ...
            override fun onFailure(call: Call<ResponseMateri1>, t: Throwable) {
